    ...
    <div className="container p-2">
      ...
      <div>
        <div className=''>
          ...
          <div className='w-full mt-2'><button className='bg-slate-600 hover:bg-slate-500 active:bg-slate-700 text-gray-200 w-full rounded-md p-2 ring-0 outline-none'>Send</button></div>
        </div>
      </div>
    </div>
  );
